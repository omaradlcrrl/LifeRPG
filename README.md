...
### Para Android 🤖
Debes tener instalado Android Studio o IntelliJ IDEA, o simplemente usar tu terminal.
...
### Para iOS 🍏
Debes usar macOS con **Xcode** previamente instalado.
Puedes abrir la sub-carpeta `/iosApp` directamente usando Xcode y pulsar el botón *Run*, o lanzar la app a un simulador de iPhone directamente desde IntelliJ / Fleet IDE.